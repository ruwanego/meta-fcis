...
This project is indexed by GitNexus as **meta-fcis** (595 symbols, 977 relationships, 28 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
