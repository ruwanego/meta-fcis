...
This project is indexed by GitNexus as **meta-fcis** (1018 symbols, 1525 relationships, 46 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
