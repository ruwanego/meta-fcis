...
This project is indexed by GitNexus as **meta-fcis** (670 symbols, 1093 relationships, 33 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
